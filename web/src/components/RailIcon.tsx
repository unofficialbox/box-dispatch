...
export function RailIcon({ name }: { name: 'grid' | 'rocket' | 'document' | 'clock2' | 'settings' | 'help' }) {
  ...
  if (name === 'clock2') return <span className="boe-rail-icon" aria-hidden="true" dangerouslySetInnerHTML={{ __html: boxIconography.clock2 }}/>
