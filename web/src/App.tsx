...
function App() {
  ...
  const content = screen === 'overview'
    ? <OverviewPage plan={plan} connections={connections} deployments={deployments} run={run} onNewDeployment={beginNewDeployment} onContinue={continueSavedDeployment} onBoxConnection={openBoxConnection} onSalesforceConnection={openSalesforceConnection} onOpenProvider={openProvider} onViewHistory={() => navigateTo('history')} onOpenDeployment={openHistoricalDeployment}/>
    : screen === 'history'
      ? <HistoryPage deployments={deployments} selectedDeploymentID={historyDeploymentID} onOpenDeployment={openHistoricalDeployment} onCloseDeployment={() => navigateTo('history')} onOpenDestination={openDestination} onViewChanges={openDeploymentChanges}/>
      : screen === 'settings'
